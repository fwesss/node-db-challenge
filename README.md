...
- [x] Explain the difference between `Relational Databases` and `SQL`.
  ...
  SQL is the language used to communicate with databases. Relational databases are the actual databases and store related data.

- [x] Why do tables need a `primary key`?

  Primary keys ensure the integrity of a database table. They are unique and non nullable and make sure every row has a unique identifier.
...
- [x] What do we need in order to have a _many to many_ relationship between two tables.
  ...
  A bridge table that has a foreign key for each table it's connecting.
